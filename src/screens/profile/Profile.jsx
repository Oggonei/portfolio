...
const ProfileScreen = () => {
  return (
    <>
        ...
        <div className="box-container_1">
          <Box title="Personal Information">
            <div className="profile-content">
              ...
              <div className="profile-content-text">
                ...
                <p className="profile-content-profession">
                  Mechatronic Engineer
                </p>
                <p className="profile-content-location">Bogotá, Colombia</p>
                <div className="separator"></div>
                <p className="profile-content-abstract">
                  Mechatronic engineer, with more than two years of experience
                  in IT companies in web development and technical support. I am
                  interested in Full Stack areas to provide solutions in the
                  field of web development, I consider myself passionate about
                  technology since I am always looking for learning spaces to
                  apply my knowledge in different projects
                </p>
              </div>
            </div>
          </Box>
          ...
          <Box title="Contact">
            <div className="inlineInformation">
              <InlineInformation
                logo={<ImMail style={{ fontSize: "25px" }} />}
                information="csantosoggonei@gmail.com"
                url="mailto:csantosoggonei@gmail.com"
              />
              <InlineInformation
                logo={<FaWhatsappSquare style={{ fontSize: "27px" }} />}
                information="+57 3214642753"
                url="https://wa.me/573214642753"
              />
              <InlineInformation
                logo={<FaLinkedin style={{ fontSize: "27px" }} />}
                information="@CristhianSantosOggonei"
                url="https://www.linkedin.com/in/cristhiansantosoggonei/"
              />
              <InlineInformation
                logo={<FaGithubSquare style={{ fontSize: "27px" }} />}
                information="@Oggonei"
                url="https://github.com/Oggonei"
              />
              <InlineInformation
                logo={<FaInstagramSquare style={{ fontSize: "27px" }} />}
                information="@oggonei"
                url="https://www.instagram.com/oggonei"
              />
            </div>
          </Box>
          ...
          <Box title="Skills">
            <div className="skills-container">
              <InlineInformation
                logo={<DiReact style={{ fontSize: "25px" }} />}
                information="React"
              />
              <InlineInformation
                logo={<DiJavascript1 style={{ fontSize: "25px" }} />}
                information="Javascript"
              />
              <InlineInformation
                logo={<DiBootstrap style={{ fontSize: "25px" }} />}
                information="Bootstrap"
              />
              <InlineInformation
                logo={<DiSass style={{ fontSize: "25px" }} />}
                information="SASS"
              />
              <InlineInformation
                logo={<DiCss3 style={{ fontSize: "25px" }} />}
                information="CSS"
              />
              <InlineInformation
                logo={<DiHtml5 style={{ fontSize: "25px" }} />}
                information="HTML"
              />
            </div>
          </Box>
          ...
          <Box title="Professional Education">
            <div className="ProfessionalEducation-Container">
              <BlockInformation
                ...
                time="2022"
              />
              <List functions={["Cataluña University."]} />
              <BlockInformation
                position="Mechatronic Engineer"
                date="Jun/2016 to Jun/2021"
                time="2021"
              />
              <List functions={["ECCI University."]} />
              <BlockInformation
          ...
          <Box title="On-line Education (Web Development)">
            <div className="onlineEducation-container">
              <div className="onlineEducation-container-udemy">
                <span className="onlineEducation-container-udemy-logo">
                  <SiUdemy />
                </span>
                <p className="onlineEducation-container-udemy-name">
                  Udemy (1 certificate)
                </p>
              </div>
              <div className="onlineEducation-container-platzy">
                <span className="onlineEducation-container-platzy-logo">
                  <SiPlatzi />
                </span>
                <p className="onlineEducation-container-platzy-name">
                  Platzy (28 certificates)
                </p>
              </div>
            ...
            <div className="projects-container">
              <div className="projects-container_projects">
                ...
                <div className="projects-container_projects-button">
                  <a
                    href="https://oggonei.github.io/project-task-machine/"
                    target="_blank"
                    rel="noreferrer"
                  >
              ...
              <div className="projects-container_projects">
                ...
                <div className="projects-container_projects-button">
                  <a
                    href="https://creditsimulator.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <button>View project</button>
              ...
              <div className="projects-container_projects">
                ...
                <div className="projects-container_projects-button">
                  <a
                    href="https://crm-administrator.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <button>View project</button>
              ...
              <div className="projects-container_projects">
                ...
                <div className="projects-container_projects-button">
                  <a
                    href="https://administradorcitasvet.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <button>View project</button>
              ...
              <div className="projects-container_projects">
                ...
                <div className="projects-container_projects-button">
                  <a
                    href="https://global-cryptocurrency-quote.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <button>View project</button>
              ...
              <div className="projects-container_projects">
                ...
                <div className="projects-container_projects-button">
                  <a
                    href="https://image-finder-px.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <button>View project</button>
              ...
              <div className="projects-container_projects">
                ...
                <div className="projects-container_projects-button">
                  <a
                    href="https://weather-appi-js.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <button>View project</button>
              ...
              <div className="projects-container_projects">
                ...
                <div className="projects-container_projects-button">
                  <a
                    href="https://recipefinder-app2.netlify.app/index.html"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <button>View project</button>
              ...
              <div className="projects-container_projects">
                ...
                <div className="projects-container_projects-button">
                  <a
                    href="https://carritodecompras-oggonei.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <button>View project</button>
              ...
              <div className="projects-container_projects">
                ...
                <div className="projects-container_projects-button">
                  <a
                    href="https://mailvalidator.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <button>View project</button>
              ...
              <div className="projects-container_projects">
                ...
                <div className="projects-container_projects-button">
                  <a
                    href="https://cotizadorsegurorvehiculos.netlify.app"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <button>View project</button>
              ...
              <div className="projects-container_projects">
                ...
                <div className="projects-container_projects-button">
                  <a
                    href="https://presupuestosemana.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <button>View project</button>
      ...
      <p className="footer">
        This webPage was created using React and SASS to see projects with more
        technologies such as Javascript, Css, bootstrap and more, go to the
        "projects" section
      </p>
    </>
  );
